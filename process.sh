...
cat output/_ammo_3.ttl output/_coo1980_skosified.ttl output/_hisco.ttl data/hisco_additional.ttl input/collections_and_schemes.ttl input/ammo_additions.ttl | rapper - "http://ldf.fi/ammo/" -i turtle -o turtle > output/_ammo_combined.ttl
